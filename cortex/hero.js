...
(function () {
  ...
  ready(function () {
    ...
    style.textContent =
      ...
      '.cxhclip{position:absolute;inset:0;overflow:hidden;pointer-events:none;z-index:1;-webkit-mask:linear-gradient(to bottom,transparent 0%,transparent 14%,#000 27%,#000 73%,transparent 86%,transparent 100%);mask:linear-gradient(to bottom,transparent 0%,transparent 14%,#000 27%,#000 73%,transparent 86%,transparent 100%);}' +
