/* Cortex Google file marks — official product icons only for matching items
   inside the Meadowlark Brand Assets slide. */
(function () {
  var css = document.createElement('style');
  css.setAttribute('data-cortex-google-file-marks-v2', 'true');
  css.textContent =
